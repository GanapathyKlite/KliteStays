...
else
{
	...
	if($_POST['getmods']=="customerpaswdup")
	{
		...
		$updateuser_result = $database->query("update ps_customers set password='".password_hash($_POST['customerpaswdconfirm'],PASSWORD_DEFAULT)."' where id_customer='".$_POST['customerid']."'")->fetchAll();
