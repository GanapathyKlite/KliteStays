...
ob_start();
 ...
 <td width="80%"  align="left" style="font-size:20px;font-weight: bold;">Service Confirmation Voucher </td> 
  <td width="20%" align="left" style="font-weight:600;font-size: 16px;color: #000000;text-align: right;"> company Name </td>  
</tr> 
<tr><td> &nbsp;  </td> </tr>
<tr>
<td colspan=2  align="left" style="line-height:1.5;color: #555555;font-size:13px;">BTT Booking ID - IN1706B5S4151195  </td>
</tr>
<!--<tr>
<td colspan=2   align="left" style="line-height:1.5;color: #555555;font-size:13px;" >Service Voucher No - NH8108053714032  </td>
</tr>-->

<tr>
<td colspan=2 width="100%" align="left" style=";line-height:1.5;border-bottom:1px solid #ddd;color: #555555;font-size:13px;">Booking Date - Fri, 09 Jun 2017  </td>
</tr>

<tr> 
  
  <td   align="left" style="font-size:12px;color: #555555;line-height:2;color:#000;">Dear MADANA KUMAR,  </td>  
...
<tr>
<td   align="left" style="line-height:2;font-size:12px;color: #555555">Thank you for using Buddies to book your hotel accommodation. </td>
</tr>
<tr>
<td    align="left" style="line-height:2;font-size:12px;color: #555555" >For your reference, your BTT Booking ID is IN1706B5S4151195.  </td>
</tr>
...
<tr>
<td  align="left" style="line-height:1.5;font-size:12px;color: #555555 ">
Mallital, Nainital
...
<!--<tr>
<td  align="left" style="line-height:2;font-size:13px;font-weight: bold;color: #000000; ">
Hotel/Service Provider Confirmation Number:
 </td>
</tr>-->

<tr>
<td  align="left" style="line-height:2;font-size:13px; "><b>Primary Guest:</b> <span style="color:#555555;font-size:12px; ">MADANA KUMAR </span>
 </td>
</tr>

<tr>
<td  align="left" style="line-height:2;font-size:13px; ;color: #000000; ">
<b>No. of Rooms:</b> <span style="font-size:12px;color: #555555;"> 2 </span> </td>
</tr>
</table>
...
<b>Check in:  </b> <span style="font-size:12px;color: #000">Mon, Jun 12, 2017 12:00 PM </span> </td>
  <td width="40%" align="center" style="line-height:2;font-size:13px; ;color: #000;border: 1px solid #ddd;    background-color: #ddd; ">
<b>Check out:   </b> <span style="font-size:12px;color: #000">Thu, Jun 15, 2017 12:00 PM</span> </td>
  <td width="20%" align="center" style="line-height:2;font-size:13px;color:#000;border: 1px solid #ddd; background-color: #ddd; ">
<b>No. of Night(s):</b> <span style="font-size:12px;color:#000;">3 </span> </td>
</tr>

<tr>

 <td width="40%" align="center" style="line-height:2;font-size:13px;border: 1px solid #ddd ;color: #000000;  ">
<b>Room Type,Category:</b> <span style="font-size:12px;color: #555555">Double,Super Deluxe</span> </td>

<td width="40%" align="center" style="line-height:2;font-size:13px;border: 1px solid #ddd ;color: #000000; ">
<b>Guest:</b> <span style="font-size:12px;color: #555555">2 Adult  </span> </td>

<td width="20%" align="center" style="line-height:2;font-size:13px;border: 1px solid #ddd;color: #000000; ">
<b>Meal Plan: </b> <span style="font-size:12px;color: #555555">Breakfast  </span> </td>
...
<tr> 
  ...
  <td colspan="3" align="left" style="font-weight:600;font-size: 16px;color: #000000;line-height:2;">Room 2</td>  
</tr> 
 <tr> 
 <td width="40%" align="center" style="line-height:2;font-size:13px;color: #000;border: 1px solid #ddd; background-color:#ddd;">
<b>Check in:  </b> <span style="font-size:12px;color: #000">Mon, Jun 12, 2017 12:00 PM </span> </td>
...
<table>
 <tr> 
 <td width="40%" align="center" style="line-height:2;font-size:13px;border: 1px solid #ddd ; ">
<b>Room Type,Category:</b> <span style="font-size:12px;color: #555555">Double,Super Deluxe</span> </td>
  <td width="15%" align="center" style="line-height:2;font-size:13px;border: 1px solid #ddd ; ">
<b>Guest:</b> <span style="font-size:12px;color: #555555">3 Adult  </span> </td>
   <td width="25%" align="center" style="line-height:2;font-size:13px;border: 1px solid #ddd; ">
<b>No of Extra Bed(Adult):</b> <span style="font-size:12px;color: #555555;">1  </span> </td>
<td width="20%" align="center" style="line-height:2;font-size:13px;border:1px solid #ddd ; ">
<b>Meal Plan: </b> <span style="font-size:12px;color: #555555">Breakfast  </span> </td>
</tr>
</table>
...
<td style="font-size:12px;text-align:justify;color: #555555"><ul>
<li style="color: ">
