...
<div class="container flight_container" style="border:1px solid rgba(0, 0, 0, 0.27);" >
...
<?php 
	...
	foreach($detailsArr as $pnrKey => $detial){ if($i==1){ $i++;?>
		<div class="row ">
			...
			<h4 class="heading">E - Ticket</h4>
			<p><span class="pnr_bold">Booking Date on:</span> <?php echo $detial['IssueDate']; ?></p>

			</div>

			<div class="col-md-6 col-sm-6 col-xs-6 travels_name"  >
				<div class="date_bo" ><p ><?php echo $_SESSION['agentname'];?></p></div>
			</div>
...
<?php  if($pnrKey!=$pnr){ ?>
	<hr class="company_name_line">
	<div class="row compa_name" style="">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<h4  class="iterinary" style=""><?php if($inc==1){ echo 'Iterinary and Reservation Details';  $inc++; } else { echo 'Return Journey';} ?></h4>


		<div class="col-md-6 col-sm-6 col-xs-6 travels_name" style="padding-left:0px; text-align: left;" >
			<p><span class="pnr_bold">Booking ID:</span> <?php echo $segmentVal['BTBookingId']; ?></p>
		</div>

		<div class="col-md-6 col-sm-6 col-xs-6 travels_name" style="padding-right:0px; text-align: right;"  >
		<p ><span style="font-weight: 500;">Airline PNR:</span> <b><?php  echo $pnrKey; ?></b></p>
		</div>
		</div>
	</div> 
<?php } ?>
	<div class="main_detail" style="">
			<div class="row flight_rows " style="        ">
			
					<div class="col-md-3 col-sm-2 col-xs-2">
					<div class="flight_names"  style=""">
					<p><?php echo $segmentVal['AirlineName'].' '.$segmentKey; ?></p>
				


					</div>
					</div>
					<div class="col-md-3 col-sm-4 col-xs-4" style="border-left: 1px solid #ccc; min-height: 112px;">
					<div style="">
					<p >Departure</p>
					<p ><span class="arrival_citys"><?php echo $segmentVal['segmentOriginCityCode'].'('.(!empty($segmentVal['segmentOriginAirportName']) && strpos($segmentVal['segmentOriginAirportName'],$segmentVal['segmentOriginCityName']) === false ? $segmentVal['segmentOriginAirportName'].', '.$segmentVal['segmentOriginCityName'] : $segmentVal['segmentOriginCityName']).')'; ?></span><span class="arrival_citys"> <?php if(isset($segmentVal['segmentOriginTerminal']) && !empty($segmentVal['segmentOriginTerminal'])){ ?>Terminal <?php echo $segmentVal['segmentOriginTerminal'];} ?></span></p>

					<p><?php echo date('l, j M, Y H:i',strtotime($segmentVal['segmentOriginDepTime'])); ?></p>
					</div>
					</div>
					<div class="col-md-3 col-sm-4 col-xs-4" style="border-right: 1px solid #ccc; min-height: 112px;">
					<div  style="">
					<p>Arrival</p>
					
					<p ><span class="arrival_citys"><?php echo $segmentVal['segmentDestinationCityCode'].'('.(!empty($segmentVal['segmentDestinationAirportName']) && strpos($segmentVal['segmentDestinationAirportName'],$segmentVal['segmentDestinationCityName']) === false ? $segmentVal['segmentDestinationAirportName'].', '.$segmentVal['segmentDestinationCityName'] : $segmentVal['segmentDestinationCityName']).')'; ?></span>,<span class="arrival_citys"><?php if(isset($segmentVal['segmentDestinationTerminal']) && !empty($segmentVal['segmentDestinationTerminal'])){ ?>Terminal <?php echo $segmentVal['segmentDestinationTerminal'];} ?></span></p>
					<p><?php echo date('l, j M, Y H:i',strtotime($segmentVal['segmentDestinationArrTime'])); ?></p>
					</div>
					...
					<p>Cabin :<?php echo (isset($segmentVal['segmentFareClass']) && !empty($segmentVal['segmentFareClass']) ? $segmentVal['segmentFareClass'].' Class' : ''); ?></p>
					</div>
					</div>
			...
			<div  class="col-md-4 col-sm-4 col-xs-4"><p class="meal_bold"><?php echo (isset($segmentVal['segmentStopPoint']) && !empty($segmentVal['segmentStopPoint']) ? $segmentVal['segmentStopPoint'].' Stop(s)' : 'stop'); ?> flight</p></div>
			<div class="col-md-4 col-sm-4 col-xs-4">
			<p class="meal_bold">Meal Plan:<span class="arrival_citys">vegetarian</span></p>
			</div>
			<div class="col-md-4 col-sm-4 col-xs-4">
			<p class="meal_bold">Baggages: <span class="arrival_citys">25kg</span></p>
			</div>
			...
			<div  class="passangerhead" style="">
			
			<div ><div class="row passenger_heading" style="">
			
					<div class="col-md-1 col-sm-1 col-xs-1 sno">
					<p class="passenger_name"><i class="sno">S.no</i></p>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4 sno">
					<p class="passenger_name"><i class="sno"> Passenger Name</i></p>
					</div>
					<div class="col-md-2 col-sm-2 col-xs-2 sno">
					<p class="passenger_name"><i class="sno">Type</i></p>
					</div>
					<div class="col-md-2 col-sm-2 col-xs-2 sno">
					<p class="passenger_name"><i class="sno">Gender</i></p>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-3 sno">
					<p class="passenger_name"><i class="sno">Ticket Number</i></p>
					</div>
			...
			<div>
					...
					<div class="col-md-4 col-sm-4 col-xs-4">
					<p><?php echo $passenger['passengerTitle'].' '.$passenger['passengerFirstName'].' '.$passenger['passengerLastName']; ?></p>
					</div>
					...
					<div class="col-md-2 col-sm-2 col-xs-2">
					<p><?php echo ($passenger['passengerGender'] == 1 ? 'Male' : 'Female');?></p>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-3">
					<p><?php echo $passenger['passengerTicketNumber']; ?></p>
					</div>
...
<!--   -->
			<div class="baggage_allowance">
		
			
			<div class="row eticke" style="   ">
			<div class="col-md-6 col-sm-6 col-xs-6	 etickets">
			<p>This is an electronic ticket . Please carry a positive idenfication forcheck in.</p>
			</div>
			<div class="col-md-3 col-sm-3 col-xs-3 airfare_table">
				<p>Air Fare</p>
				<p>Jn Tax</p>
				<p>Fees&Surcharge</p>
				<p class="totals">Total Fare</p>
			</div>
			<div class="col-md-3 col-sm-3 col-xs-3 amountss" >
				<p class="amounts"><span class="fa fa-inr inrs"></span	><span class="rupees"><?php echo number_format($totalBaseFare,2,'.',''); ?></span></p>
				<p class="amounts"><span class="fa fa-inr inrs"></span><span class="rupees"><?php echo number_format($totalJNTax,2,'.',''); ?></span></p>
				<p class="amounts"><span class="fa fa-inr inrs"></span><span class="rupees"><?php echo number_format($totalFeeSur,2,'.',''); ?></span></p>
				<p class="amounts totals"><span class="fa fa-inr inrs"></span><span class="rupees"><?php echo number_format(round($totalPublishedFare),2,'.',''); ?></span></p>
			</div>
			</div>
...
<div class="row terms_conditio"  >
		<div class="col-md-12 col-sm-12 col-xs-12 ">
		<p class="terms_condi">Terms and Conditions:</p>
		<ol class="condition_ul">
		...
		<li>The conditions may be obtained from the issuing carrier.If the passenger's journey involves an ultimate destination or stop in a country</li>
		<li>other than country of departure the Warsaw convention may be applicable and convention governs and in most case limits the </li>
		<li>liablity of carriers for death or personal injury and in respect of loss of or damage to baggage</li>
		</ol>
		</div>
