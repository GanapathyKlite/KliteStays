...
<?php 
	...
	<table style=" width:100%;color: #555555;font-size:10px;line-height:1.5; "> 
            <tr>
                ...
                <td rowspan="3" style="font-size: 12px ;text-align:right; border-bottom:1px solid #eee;">'.$_SESSION['agentname'].'</td>
            </tr>
              ...
              <tr><td colspan="4">&nbsp;</td></tr>
                ...
                <td style="text-align: center;">'.$segmentVal['AirlineName'].' '.$segmentKey.' 
                 ...
                 <td style="text-align: center;border-right:1px solid #eee;">Arrival<br>
                   <b> .'$segmentVal['segmentDestinationCityCode'].'('.(!empty($segmentVal['segmentDestinationAirportName']) && strpos($segmentVal['segmentDestinationAirportName'],$segmentVal['segmentDestinationCityName']) === false ? $segmentVal['segmentDestinationAirportName'].', '.$segmentVal['segmentDestinationCityName'] : $segmentVal['segmentDestinationCityName']).')'.'</b>';?>
                   ...
                   <?php $html.='<b>Terminal 2</b><br>
                   '. date('l, j M, Y H:i',strtotime($segmentVal['segmentDestinationArrTime'])).'
                 </td>
                 <td style="text-align: center;">Cabin: .'(isset($segmentVal['segmentFareClass']) && !empty($segmentVal['segmentFareClass']) ? $segmentVal['segmentFareClass'].' Class' : '').'<br>
                  
                 </td>
                
                </tr>
                <tr>
                <td> .'(isset($segmentVal['segmentStopPoint']) && !empty($segmentVal['segmentStopPoint']) ? $segmentVal['segmentStopPoint'].' Stop(s)' : 'stop').'
                </td>
                <td colspan="2">Meal Plan: <b>North Indian meals</b></td>
                <td >Baggages: <b>25kg</b></td>
...
$html.='        
        ...
        <tr>
            ...
            <td>Airfare </td>
            <td>.' number_format($totalBaseFare,2,'.','').'</td>
            <td style="">&emsp;&emsp;&emsp;&emsp;</td>
        </tr>
        <tr>
            <td>JnTax</td><td> .' number_format($totalJNTax,2,'.','')'.</td>
        </tr>
        <tr>
            <td>Fees & Surcharge</td><td>.' number_format($totalFeeSur,2,'.','').'</td>
        </tr>
        <tr>
            <td>Total Fare</td><td>'.number_format(round($totalPublishedFare),2,'.','').'</td>
        </tr>
