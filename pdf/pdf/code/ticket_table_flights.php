	...
	if(isset($ticketDetails) && !empty($ticketDetails)){
		foreach($ticketDetails as $ticket){
			...
			foreach($segmentAirlineNumberArr as $segmentKey => $segmentVal){
				$detailsArr[$ticket['PNR']]['BTBookingId']=$ticket['BTBookingId'];
...
<?php 
    ...
    <?php
	$html .= '
	<table style=" width:100%;color: #555555;font-size:12px;font-family: serif; "> 
            <tr>
                <td style="color:black;font-size: 20px;font-weight: bold;" >E-Ticket</td>
                <td ></td>
            </tr>
               <tr>
                <td style="" >Booking ID: <span style="color:black;"> '.$detial['BTBookingId'].'</span></td>
                <td  rowspan="2"  style="font-size: 15px ;text-align:right; border-bottom:1px solid #eee;">'.$_SESSION['agentname'].'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            </tr>
            
            <tr>
                <td style="border-bottom:1px solid #eee;" >Booking Date on: <span style="color:black;">'.$detial['IssueDate'].'</span></td>
            </tr>
...
<?php
$html .= '
    <table style=" width:100%;color: #555555; font-size:12x; font-family: serif; line-height:1">
        <tr>
            <td colspan="2"> &nbsp;</td>
        </tr>
        <tr >
                <td  style="font-size: 13px;margin-bottom: 5px;margin-top: 20px;color: black !important;">';
				?>
				<?php if($inc==1){ $html .= '<Span style="color:black;">Iterinary and Reservation Details</span>';  $inc++; } else { $html .= 'Return Journey';} ?>
			<?php
			$html .= '
				</td>
                   <td style="text-align:right;font-size:12px;">Airline Pnr: <span style="color:black;">'.$pnrKey.'</span></td>
            </tr>
           <!-- <tr>
                <td style="font-size:12px;">Booking ID: <span style="color:black;font-size:12px;"> '.$segmentVal['BTBookingId'].'</span></td>
                <td style="text-align:right;font-size:12px;">Airline Pnr: <span style="color:black;"> '.$pnrKey.' </span></td>
...
$html.='        
        ...
        <tr>
            <td style="text-align:right;"><b>Total Fare</b>&nbsp;&nbsp;  <img src="images/rupes.png" height="9px" width="9px;"></td><td style="text-align:right;"><b>'.number_format(round($totalPublishedFare),2,'.','').'</b> </td>
         ...
         <table style="color: #555555;font-size:12px; font-family: serif;">
         <tr>
            <td width="126px" style="border-bottom:1px solid #eee;color:black;">Terms and Conditions:-</td>
         </tr>
