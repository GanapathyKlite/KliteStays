	...
	$(document).ready(function () {
		staysinn_script.init();
	});
	
	$(window).load(function() {
		staysinn_script.load();
	});
	...
	var staysinn_script = {
		...
		init: function () {
			...
			$(".ribbon li a").click(staysinn_script.handleRibbonClick);
		...
		resizeFluidItems: function() {
			staysinn_script.resizeFluidItem(".one-half.accommodation_item,.one-third.accommodation_item,.one-fourth.accommodation_item,.one-fifth.accommodation_item");
			staysinn_script.resizeFluidItem(".one-half.location_item,.one-third.location_item,.one-fourth.location_item,.one-fifth.location_item");
			staysinn_script.resizeFluidItem(".one-half.tour_item,.one-third.tour_item,.one-fourth.tour_item,.one-fifth.tour_item");
			staysinn_script.resizeFluidItem(".one-half.car_rental_item,.one-third.car_rental_item,.one-fourth.car_rental_item,.one-fifth.car_rental_item");
			staysinn_script.resizeFluidItem(".one-half.cruise_item,.one-third.cruise_item,.one-fourth.cruise_item,.one-fifth.cruise_item");
		},
