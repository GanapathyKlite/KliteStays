...
$updateuser_resulta = $database->query("update ps_agents set reference='".$reference."' where id_agent='".$lastID."'")->fetchAll();
...
if(isset($file_type) && !empty($file_type) && file_exists('uploads/agent.'.$file_type)){
...
$mail->SetFrom($adminemail, "buddiestours.com");
...
else if($_GET['getmods']=="uploadimg")
	{
...
if(isset($file_type) && !empty($file_type) && file_exists('../uploads/agent.'.$file_type)){
		...
		$updateagent_result = $database->query("update ps_agents set username='".$_POST['username']."', password='".$_POST['password']."', agentname='".$_POST['agent_name']."', pan_no='".$_POST['pan_number']."', address='".$_POST['address']."', city='".$_POST['city']."', pincode='".$_POST['pin_code']."', id_state='".$_POST['state']."', id_country='".$_POST['country']."', telephone='".$_POST['telephone_no']."', mobile='".$_POST['mobile_no']."', fax='".$_POST['fax_no']."', email='".$_POST['email_id']."', website='".$_POST['website']."', date_upd='".$dateadd."', description='".$_POST['desc']."', services_offered='".$_POST['services_offered']."', logo_ext='".$_POST['sortpicture']."' where reference='".$_POST['agentrefid']."'")->fetchAll();
