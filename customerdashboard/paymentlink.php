...
?>	  <div id="page-wrapper">
						...
						<div class="contain recharge_containe" style=" margin: 0px auto;"><?php
							...
							$MERCHANT_KEY = 'uYnsxR';//"gtKFFx";
							$SALT = 'WTEzbwt4';//"eCwWELxi";
					...
					<div class="col-xs-1 col-sm-1"></div>
						<div class="col-xs-11 col-sm-offset-1 col-sm-7">
                           ...
                           <!-- <div class="row">
							...
							<button type="submit" class="btn cubtn" id="makepayment" disabled>Generate Payment Link</button>
                            </div>      
							...
							<div class="row" id="payment_link_div" style="">
							<div class="col-md-12 col-sm-12 col-xs-12" id="payment_link_url">
                            </div>      
							</div>
							...
							<input type="hidden" name="surl" value="<?php echo (isset($_POST['surl']) ? $_POST['surl'] : $root_dir.'agentdashboard/secure.payment.php'); ?>" />
...
$(document).ready(function(e) {
	$('#defaultForm1').submit(function(){
		...
		var hash = $('#hash').val();
		var amt = btoa($('#amount').val());
		var agentId = btoa('<?php echo $_SESSION['authtnid']; ?>');
		var url = '<?php echo $root_dir.'agentdashboard/secure.paymentlink.php?k='; ?>'+agentId+'&a='+amt;//+'&h='+hash;
		$('#payment_link_url').html(url);
