...
$SECURE_SECRET = "58492E790DFFB66349296AF93C5ED0F3";//"4B9EEF9724E2260A3F1B98A3A301E45E";
...
<html>
    <head>
        <title><?php echo getResponseDescription($txnResponseCode) ?> - Response Page</title>
...
color:#d92525;
        ...
        <link href="http://buddiestours.com/css/style.css" type="text/css" rel="stylesheet" />
    </head>
    <body>
...
//} ?>    </table>
        ...
        <div style="margin:0 auto;top:25%;width:500px;height:300px;position:relative;" class="panel panel-default">
		...
		$amount=sprintf ("%.2f",$amount);
         ...
         <div class="panel-title"><?php echo '<h1 style="position:relative;text-align:center;font-family:Coda;font-size:20px;font-weight:500;">'.getResponseDescription($txnResponseCode).'</h1>';?></div>
         </div>
        ...
        <a class="back" href="http://buddiestours.in/agent/agentdashboard">Go Back</a>
        </div>
        </div>
       <?php
   //echo "www";
		...
		$store_last_transaction = $database->query("insert into transactions values(NULL,'','','".$amount."','".$locale."','".$batchNo."','".$command."','".$message."','".$version."','".$cardType."','".$orderInfo."','".$receiptNo."','".$merchantID."','".$authorizeID."','".$merchTxnRef."','".$transactionNo."','".$acqResponseCode."','".$txnResponseCode."','".$verType."','".$verStatus."','".$token."','".$verSecurLevel."','".$enrolled."','".$authStatus."','".$date->format('Y-m-d')."', '".$date->format('h:i:s')."')")->fetchAll();
//echo "insert into transactions values(NULL,'','','".$amount."','".$locale."','".$batchNo."','".$command."','".$message."','".$version."','".$cardType."','".$orderInfo."','".$receiptNo."','".$merchantID."','".$authorizeID."','".$merchTxnRef."','".$transactionNo."','".$acqResponseCode."','".$txnResponseCode."','".$verType."','".$verStatus."','".$token."','".$verSecurLevel."','".$enrolled."','".$authStatus."','', '')";
