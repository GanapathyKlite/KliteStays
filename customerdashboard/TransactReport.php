...
<div class="Transmain">  
 ...
 <div class="container contain">
		...
		<form class="form-inline top_form" onsubmit="return false;">
			...
			<!--<div class="form-group pdf_icon" >
			<a href="#"  onclick="javascript:downloadReport('ticket');"><img src="images/pdf.png" title="Download Ticket" alt="" >Export</a>
			

			</div>
			<div class="form-group pdf_icon" >
			<a href="#"  onclick="javascript:downloadReport('ticket1');"><img src="images/pdf.png" title="Download Ticket" alt="" >Export</a>
...
<script src="js/jquery-ui.js"></script>
 <script src="js/script_transactreport.js"></script>
...
function downloadReport(type){
	if(type == 'excel')
		var url = 'excel-report/paymentReport.php?';
	else if(type == 'pdf')
		var url = 'pdf1/code/paymentReport.php?';
	window.open(url+"id=<?php echo (isset($_SESSION['authtnid']) ? $_SESSION['authtnid'] : ''); ?>&from="+$('#fromdate').val()+"&to="+$('#todate').val(), "_blank");
	return false;
}
</script>
