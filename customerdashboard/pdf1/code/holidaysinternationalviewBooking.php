<?php
	...
	{$html = '<table cellpadding="0" cellspacing="0" width="100%" style="text-align:center;">
				<tr style="background-color:#DD1B22; color:#fff;">
					...
					<td style="text-align:center; width:100px;">Departure City</td>
	...
	$html = '<table cellpadding="0" cellspacing="0" width="100%" style="text-align:center;">
				<tr style="background-color:#DD1B22; color:#fff;">
					<td style="width:50px; vertical-align:middle; padding-top:20px;">SI.No</td>
					<td style="text-align:center; width:70px; padding-top:20px;">Booking Date</td>
					<td style="text-align:center; width:130px;">Booking ID</td>
					<td style="text-align:center; width:100px;">Customer</td>
					<td style="text-align:center; width:100px;">Contact</td>
					<td style="text-align:center; width:150px;">Package Code</td>
				...
				foreach($booking_details as $row)
				{
					...
					$html .= '
						<tr style="border:1px solid red;">
							...
							<td style="text-align:center; font-size:8px;width:60px;">'.$row['mobile'].'</td>
							<td style="text-align:center;font-size:8px;width:80px;">'.$row['txtHolidaysPackageName'].'</td>
							<td style="text-align:center;font-size:8px;width:100px;">'.$row['to_name'].'</td>
							<td style="text-align:center;font-size:8px;width:80px;">'.$row['grandtotal'].'</td>
						...
						<tr><td colspan="10" style="border-top:1px solid #0171B6; height:1px;"></td></tr>';
					}
					else
					{
						$html .= '
						<tr style="border:1px solid red;">
							<td style="width:50px; vertical-align:middle; padding-top:30px;">'.$i.'</td>
							<td style="text-align:center; width:70px; font-size:8px; padding-top:10px;">'.date('Y-m-d', strtotime($row['booking_date'])).'</td>
						
							<td style="text-align:center;font-size:8px; width:130px;">'.$row['booking_ref'].'</td>
							<td style="text-align:center; font-size:8px;width:100px;">'.$row['name'].'</td>
							<td style="text-align:center; font-size:8px;width:100px;">'.$row['mobile'].'</td>							
							<td style="text-align:center;font-size:8px;width:150px;">'.$row['txtHolidaysPackageName'].'</td>
							<td style="text-align:center;font-size:8px;width:130px;">'.$row['to_name'].'</td>
						</tr>
						<tr><td colspan="7" style="border-top:1px solid #0171B6; height:1px;"></td></tr>';
					}
					$i++;
				}
				$html .='</table>';
...
$pdf->SetKeywords('TCPDF, PDF, example, test, Holidays');
...
{
	$type="International Holidays BOOKING REPORT";
}
...
$pdf->Output('holidaysinternationalReport.pdf', 'D');
