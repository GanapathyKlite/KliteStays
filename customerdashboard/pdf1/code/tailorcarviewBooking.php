<?php
	...
	$html = '<table cellpadding="0" cellspacing="0" width="100%" style="text-align:center;">
				<tr style="background-color:#DD1B22; color:#fff;">
					...
					<td style="text-align:center; width:150px;">Arrival City</td>
		...
		$booking_details=$database->query("select * from ps_car_tailor_booking where agent_id='".$id_agent."' and is_cancel in(".$cancel.$pend.")".$where." order by booking_date DESC")->fetchAll();
				...
				foreach($booking_details as $row)
				{
					...
					else
					{
						...
						<tr style="border:1px solid red;">
							...
							<td style="text-align:center;font-size:8px;width:150px;">'.$row['source_name'].'</td>
...
{
	$type="TAILOR CAR BOOKING REPORT";
}
...
$pdf->Output('tailorcarReport.pdf', 'D');
