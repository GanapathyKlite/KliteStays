...
if(isset($availableRoomsList) && !empty($availableRoomsList)){
  foreach($availableRoomsList as $incKey => &$roomVal){
    ...
    foreach($daterange as $dateK => $date){
      ...
      $periodicRate = [];$without_periodicRate = [];
        ...
        <ul>
          ...
          <article class="refine-search-results byt_search_widget BookYourTravel_Search_Widget">
                      <div class="dropdown col-xs-12">
                          ...
                          <h2 class="show_hide_type"><?php echo $text1;?> In <?php echo ucwords($_GET['city'])?></h2><Span class="show_atag_hotel" href="#hotelTypes" data-toggle="collapse" >Show</Span>
                          <hr >
      ...
      <ul>
       ...
       <ul>
          ...
          <article class="refine-search-results byt_search_widget BookYourTravel_Search_Widget">
            ...
            <h2><?php echo $text1?> in <?php echo ucwords($destination);?> By Star Rating </h2>
        ...
        <ul>
          ...
          <article class="refine-search-results byt_search_widget BookYourTravel_Search_Widget">     
                  <div class="dropdown col-xs-12">
                         ...
                         <h2>Nearest Airports In <?php echo ucwords($_GET['city'])?> </h2>
          ...
          <article class="refine-search-results byt_search_widget BookYourTravel_Search_Widget">     
                  <div class="dropdown col-xs-12">
                          ...
                          <h2>Top Flights To <?php echo ucwords($_GET['city'])?> </h2>
        ...
        <ul>
          ...
          <article class="refine-search-results byt_search_widget BookYourTravel_Search_Widget">     
                  <div class="dropdown col-xs-12">
                         ...
                         <h2>Top Flights From <?php echo ucwords($_GET['city'])?> </h2>
        ...
        <ul>
          ...
          <article class="refine-search-results byt_search_widget BookYourTravel_Search_Widget">     
                  <div class="dropdown col-xs-12">
                        ...
                        <h2>Top Buses To <?php echo ucwords($_GET['city'])?> </h2>
        ...
        <ul>
          ...
          <article class="refine-search-results byt_search_widget BookYourTravel_Search_Widget">     
                  <div class="dropdown col-xs-12">
                        ...
                        <h2>Top Buses From <?php echo ucwords($_GET['city'])?></h2>
        ...
        <ul>
          ...
          <article class="refine-search-results byt_search_widget BookYourTravel_Search_Widget">
                   <div class="dropdown col-xs-12">
                       ...
                       <h2><?php echo ucwords($_GET['city'])?> Map </h2>
    ...
    <a style="margin-top:10px;cursor: pointer;display: block;color:#ccc;"> <span style="color:#bb0f0f;">100</span> Reviews  <i class="fa fa-angle-right" aria-hidden="true"></i></a>
            ...
            <span class="price_span">
                           ...
                           <div class='description '>
                            ...
                            <p class="discription_overflow  data_<?php echo $count;?>"><?php //substr(("fdiusgodfug"),0,100)
               ...
               <i style="font-size: 22px;" class="fa fa-wifi" aria-hidden="true"<?php if(!in_array('internet_access_in_rooms',$hotels['amenities'])) echo 'style="color:#c8c8c8;cursor:not-allowed;font-size: 22px;position: relative; "'; ?>></i>
               </a>
...
<div class="page-content">
  ...
  <input type="hidden" id="rowcount" value="1">
                 ...
                 <div  style="box-shadow: 1px 1px 6px #ccc;padding: 13px 21px 34px;">
                  <h4 style="text-align: center;padding: 10px 0;color: #dd3236;"><?php echo $text1?> in <?php echo ucwords($destination);?> </h4>
                  <div class="seo_content_index">
                      <div class="seocontent_div">

                    <p><?php echo ucwords($_GET['city'])?> is a one of beautiful destination in <?php echo ucwords($city_name) ?></p><p> we have </p><h2><?php echo count($hotelListArr)?><h2>, <h3><?php echo $text1; ?> in <?php echo ucwords($_GET['city'])?><h3>, <h2><?php echo implode(', ',$attractions_hjf);?>, <?php echo $count_property_type[$filterHotelType[0]]; ?> <?php echo ucwords($hotel_type);?><h2> near <h2><?php echo implode(', ',$pptylandmark);?></h2>, <h3>you Can get upto 50% offer for each Booking ,find  More <?php echo $text1;?></h3><h2> <?php echo implode(', ',$prpptyname_slice); ?></h2>
                     
                     <p><?php echo $weater_desc; ?></p>
                      <p>Destination weather : <?php echo $celcius; ?><sup>.</sup>Celcius</p>
                      Destination weather Min Temp : <?php echo $temp_min; ?>
                      Destination weather Max Temp : <?php echo $temp_max; ?>
