	    ...
	    <div class="bus_tickets" >
			...
			<form class="hotel_search" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" id="hotel_search"  style="display: none">
	            ...
	            <div class="col-xs-12 col-sm-3 " style="margin-bottom: 10px;">
					...
					<button  class="rooms_in_hotel btn btn-primary" style="color:red !important;" data="<?php echo $key+1; ?>" type="button" onclick="addroom(this)" >+ Add Room</button>
					<span class="done" style="float:left;" onclick="ondone()"><i class="fa fa-check-circle-o"></i>  Done</span>
