        ...
        <div class="col-sm-12  col-md-12 col-lg-12 col-xs-12 checkbooking" style="position: relative;">
            ...
            <div class="clearfix"></div>
				...
				<div class="col-md-12" style=" margin-top:20px; padding: 0px;<?php if($noRoomsFlag){ ?>display:none;<?php } ?>">
                    ...
                    <!--<a href="#" data-toggle="tooltip" title="Per Adult: Rs.<?php echo $rateLunchAdult; ?>, Per Child: Rs.<?php echo $rateLunchMoreThanFive; ?> (5-12 yrs), Rs.<?php echo $rateLunchLessThanFive; ?> (0-5 yrs)" data-placement="top"><label><input type="checkbox" value="" class="extraRateLunch" data-type="1">Lunch Incl.</label></a>-->
                    <label><input type="checkbox" value="" class="extraRateLunch" data-type="1">Lunch Incl.</label>
                    <a href="#" data-toggle="modal" data-target="#myModalLunch" style="color: #23527c;"><span class="glyphicon glyphicon-info-sign"></span></a>
                    <div class="modal fade" role="dialog" id="myModalLunch">
                     <div class="modal-dialog" >
                        <button style="z-index: 9999;position: absolute;right: -12px;top: -15px;opacity:1;color:#fff;" type="button" class="close" data-dismiss="modal">&times;</button>
                        <div class="modal-content">
                           <div class="modal-header">Lunch Inclusion</div>
                           <div class="modal-body">
                              <div class="fare_break_mod">
                                 <div class="row ">
                                    <div class="col-xs-6">Per Adult</div>
                                    <div class="col-xs-1"><i class="fa fa-inr" aria-hidden="true"></i></div>
                                    <div class="col-xs-5"><?php echo $rateLunchAdult; ?></div>
                                 </div>
                                 <div class="row  ">
                                    <div class="col-xs-6">Per Child (5-12 yrs)</div>
                                    <div class="col-xs-1"><i class="fa fa-inr" aria-hidden="true"></i></div>
                                    <div class="col-xs-5"><?php echo $rateLunchMoreThanFive; ?></div>
                                 </div>
                                 <div class="row ">
                                    <div class="col-xs-6">Per Child (0-5 yrs)</div>
                                    <div class="col-xs-1"><i class="fa fa-inr" aria-hidden="true"></i></div>
                                    <div class="col-xs-5"><?php echo $rateLunchLessThanFive; ?></div>
                                 </div>
                              </div>
                           </div>
                        </div>
					...
					<div class="col-md-6">
                     ...
                     <!--<a href="#" data-toggle="tooltip" title="Per Adult: Rs.<?php echo $rateDinnerAdult; ?>, Per Child: Rs.<?php echo $rateDinnerMoreThanFive; ?> (5-12 yrs), Rs.<?php echo $rateDinnerLessThanFive; ?>(0-5 yrs)" data-placement="top"><label><input type="checkbox" value="" class="extraRateDinner" data-type="2">Dinner Incl.</label></a>-->
                     <label><input type="checkbox" value="" class="extraRateDinner" data-type="2">Dinner Incl.</label>
                     <a href="#" data-toggle="modal" data-target="#myModalDinner" style="color: #23527c;"><span class="glyphicon glyphicon-info-sign"></span></a>
                       <div class="modal fade" role="dialog" id="myModalDinner">
                        <div class="modal-dialog" >
                           <button style="z-index: 9999;position: absolute;right: -12px;top: -15px;opacity:1;color:#fff;" type="button" class="close" data-dismiss="modal">&times;</button>
                           <div class="modal-content">
                              <div class="modal-header">Dinner Inclusion</div>
                              <div class="modal-body">
                                    <div class="fare_break_mod" style="text-align: left;">
                                 <div class="row ">
                                    <div class="col-xs-6">Per Adult</div>
                                    <div class="col-xs-1"><i class="fa fa-inr" aria-hidden="true"></i></div>
                                    <div class="col-xs-5"><?php echo $rateDinnerAdult; ?></div>
                                 </div>
                                 <div class="row ">
                                    <div class="col-xs-6">Per Child (5-12 yrs)</div>
                                    <div class="col-xs-1"><i class="fa fa-inr" aria-hidden="true"></i></div>
                                    <div class="col-xs-5"><?php echo $rateDinnerMoreThanFive; ?></div>
                                 </div>
                                 <div class="row ">
                                    <div class="col-xs-6">Per Child (0-5 yrs)</div>
                                    <div class="col-xs-1"><i class="fa fa-inr" aria-hidden="true"></i></div>
                                    <div class="col-xs-5"><?php echo $rateDinnerLessThanFive; ?></div>
                                 </div>
                              </div>
                              </div>
                           </div>
                ...
                <div class="col-md-12" style="text-align:center;margin-top: 20px;<?php if($noRoomsFlag){ ?>display:none;<?php } ?>" id="totalhotel">
				 ...
				 ?>
					...
					<p>
						 <button type="button" class="custonlink" data-toggle="modal" data-target="#myModalFareDetails" style="font-size:12px;color:#005bff;text-decoration:underline;">Fare Breakup</button>
                  <div class="modal fade" role="dialog" id="myModalFareDetails">
                     <div class="modal-dialog" >
                        <button style="z-index: 9999;position: absolute;right: -12px;top: -15px;opacity:1;color:#fff;" type="button" class="close" data-dismiss="modal">&times;</button>
                        <div class="modal-content">
                           <div class="modal-header">Fare Breakup</div>
                           <div class="modal-body">
                                  <div class="fare_break_mod" style="text-align: left;">
                              <div class="row">
                                 <div class="col-xs-6">Base Fare</div>
                                 <div class="col-xs-1"><i class="fa fa-inr" aria-hidden="true"></i></div>
                                 <div class="col-xs-5" id="baseRateDiv"></div>
                              </div>
                              <div class="row" id="lunchRateParentDiv" style="display:none;">
                                 <div class="col-xs-6">Lunch Incl.</div>
                                 <div class="col-xs-1"><i class="fa fa-inr" aria-hidden="true"></i></div>
                                 <div class="col-xs-5" id="lunchRateDiv"></div>
                              </div>
                              <div class="row" id="dinnerRateParentDiv" style="display:none;">
                                 <div class="col-xs-6">Dinner Incl.</div>
                                 <div class="col-xs-1"><i class="fa fa-inr" aria-hidden="true"></i></div>
                                 <div class="col-xs-5" id="dinnerRateDiv"></div>
                              </div>
                              <div class="row">
                                 <div class="col-xs-6">Tax CGST</div>
                                 <div class="col-xs-1"><i class="fa fa-inr" aria-hidden="true"></i></div>
                                 <div class="col-xs-5" id="cgstRateDiv"><?php echo $totalPriceInitial*($availableRoomsList[0]['txtCGST']/100); ?></div>
                              </div>
                              <div class="row">
                                 <div class="col-xs-6">Tax SGST</div>
                                 <div class="col-xs-1"><i class="fa fa-inr" aria-hidden="true"></i></div>
                                 <div class="col-xs-5" id="sgstRateDiv"><?php echo $totalPriceInitial*($availableRoomsList[0]['txtSGST']/100); ?></div>
                              </div>
                              <div class="row">
                                 <div class="col-xs-6">Total</div>
                                 <div class="col-xs-1"><i class="fa fa-inr" aria-hidden="true"></i></div>
                                 <div class="col-xs-5" id="totalRateDiv"><?php echo $totalPriceInitial + ($totalPriceInitial*($availableRoomsList[0]['txtSGST']/100)) + ($totalPriceInitial*($availableRoomsList[0]['txtSGST']/100)); ?></div>
                              </div>
                           </div>
                           </div>
                        </div>
