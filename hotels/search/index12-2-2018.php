			...
			<form class="hotel_search" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" id="hotel_search"  style="display: none">
	            ...
	            <div class="col-xs-12 col-sm-3 " style="margin-bottom: 10px;">
					...
					<div class="collapse room_res2 "  style="" id="demo" ><!-- 
	                    ...
	                    <input type="submit" value="Search" class="btn-cus-submit btn modify_tag btn" />
					...
					<div class="column">
						...
						<div class="where rooms ">
							<div class="hotelde_inns">    
							  <p class="hotel_found"><span class="count_amount"><?php echo count($hotelListArr);?></span> Hotels found in <span><?php echo $city_name; ?></span></p>
                      ...
                      <div class="dropdown col-xs-12">
                          <h2 class="show_hide_type">Hotel Types</h6>
            ...
            <h2>Star Category</a> </h2>
              ...
              <div id="hotelAmenities" class="collapse">
                ...
                <li><a href="#"><input type="checkbox" data-sort-type="amentities" data-value="free_parking#bus_parking#indoor_parking#outdoor_parking#parking#valet_parking"><label>Parking Facility</label></a></li>
                              ...
                              <li><a href="#"><input type="checkbox" data-sort-type="amentities" data-value="room_service#room_service_24_hours"><label>Room Service</label></a></li>
...
$count1++;
    ...
    ?>
	  ...
	  <a style="margin-top:10px;cursor: pointer;display: block;color:#ccc;"> <span style="color:#bb0f0f;">100</span> Reviews  <i class="fa fa-angle-right" aria-hidden="true"></i></a>
               ...
               <i class="fa fa-wifi" style="font-size: 22px;position: relative; bottom: 3px;" aria-hidden="true"<?php if(!in_array('internet_access_in_rooms',$hotels['amenities'])) echo 'style="color:#c8c8c8;cursor:not-allowed;font-size: 22px;position: relative; bottom: 3px;"'; ?>></i>
               </a>
