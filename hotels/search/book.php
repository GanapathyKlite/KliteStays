...
$countWhere = $guestCntHidden = $guestText = $searchguest = '';
$guestcount = $countadult = $countchild = 0;
...
foreach ($availableRoomsList as $keyIte => $row) {
   ...
   if (empty($row['rate']) && empty($row['without_rate'])) {
      unset($availableRoomsList[$keyIte]);
      unset($price1[$row['id_room'] . '_' . $row['id_room_type']]);
      continue;
   }
   ...
   if (isset($row['photo_gall']) && !empty($row['photo_gall']) && $row['photo_gall'] != ',,,') {
      ...
      if (isset($room_gallery_arr) && !empty($room_gallery_arr)) {
         foreach ($room_gallery_arr as $room_gallery_arr_val) {
            ...
            //_BO_HOTEL_IMG_DIR_.'rooms/'.$row['id_room'].'/'.$row['id_room_type'].'/'.current($room_gallery_arr_val);
   ...
   <div class="wrap">
      ...
      <nav role="navigation" class="breadcrumbs">
         <ul>
            ...
            <?php } else { ?>
               <li><a href="<?php echo $_SESSION['2ndpage']; ?>" title="Hotels"><?php echo $city_name; ?></a></li>
            <?php   } ?>
                     ...
                     if (isset($availableRoomsList) && !empty($availableRoomsList) && !$noRoomsFlag) {
                        ...
                        foreach ($availableRoomsList as $room) {
                           ...
                           if (!empty($room['is_breakfast'])) {
                              foreach ($room['is_breakfast'] as $key1 => $value) {
                                 if ($value == 1) {
                     ?>
                                    <li id="room_type_206">
                                       ...
                                       <div class="meta room_type">
                                          <h3>
                                             <p style="font-size: 19px;">
                                                <?php echo (isset($room['txtRoomName']) && !empty($room['txtRoomName']) ? ucwords($room['txtRoomName']) . (isset($roomTypes[$room['id_room_type']]) && !empty($roomTypes[$room['id_room_type']]) ? ' (' . $roomTypes[$room['id_room_type']] . ')' : '') : 'Taj Club, Room, Business Lounge Access, City View'); ?></p>
                                          </h3>
                              ...
                              <div class="checkbox_width">
                                 <div class="checkbox ">
                                    ...
                                    <div class="col-xs-6" style="padding: 0">
                                       ...
                                       <a href="#" data-toggle="modal" data-target="#myModalLunch"><span class="glyphicon glyphicon-info-sign text_color" style=" position: relative;top: 1px;"></span></a>
                                    </div>

                                    <div class="col-xs-6 " style="padding: 0">
                                       <label><input type="checkbox" value="" class="extraRateDinner" data-type="2" style=" ">Dinner Incl.</label>
                                       <a href="#" data-toggle="modal" data-target="#myModalDinner"><span class="glyphicon glyphicon-info-sign text_color"></span></a>
                                    </div>
                                                ...
                                                <div class="fare_break_mod " style="text-align: left;">
                                                   ...
                                                   <p><span class="pull-left">Per Child (5-12 yrs)</span>
                                                      ...
                                                      <Span class="pull-right">
                                                         ...
                                                         <?php echo $rateLunchMoreThanFive; ?>
                                                   </p>
                                                   ...
                                                   <p>
                                                      ...
                                                      <Span class="pull-right">
                                                         ...
                                                         <?php echo $rateLunchLessThanFive; ?>
                                                   </p>
...
<script type="text/javascript">
   jQuery(document).ready(function($) {
      ...
      $('.book_room').click(function() {
         ...
         $('html, body').animate({
            scrollTop: $('#totalhotel').position().top
         }, 'slow');
      });
   });
