...
{   
	...
	//protected $username = 'b2btraveladmin_supplier';

	//protected $password = 'buddy@2017';
	...
	protected $username = 'buddinfi_holidays_admin';
	...
	protected $database_name = 'buddinfi_hotelbud_technologies';//'buddiest_admin';
