							...
							foreach ($dateValues as $yearKey => $yearVal) {
								foreach ($yearVal as $monthKey => $monthVal) {
									foreach ($monthVal as $roomKey => $dateVals) {
										...
										$res = $database->insert('ps_room_available_inventory', $finalValues);
										$res = $database->insert('ps_room_available_inventory', $finalValues1);
										//Db::getInstance()->insert('room_available_inventory',$finalValues);
										//Db::getInstance()->insert('room_available_inventory',$finalValues1);
	...
	<script>
		$(document).ready(function () {
			$.confirm({
				...
				onDestroy: function () {
					window.location = "https://www.klitestays.com";
				},
				buttons: {
					ok: function () {
					}
...
<div class="container" style="margin-top: 87px;">
	<div class="col-sm-12 col-md-10 col-md-offset-1 contain_hotelsignup">
		<form id="property_form" class="defaultForm form-horizontal" action="<?php echo $_SERVER['PHP_SELF']; ?>"
				...
				<div class="row">
					<div class="col-xs-12 col-sm-4">
						<div class="inner_sm_class">
							<p class="heading_for_input"><label class="control-label 	required">Property Type</label>
							</p>
							<p class="input_box_bord"><select name="selPropertyTypeID"
									class="form-control fixed-width-xl" id="selPropertyTypeID">
									<option value=""></option>
					...
					<div class="col-xs-12 col-sm-4">
						<div class="inner_sm_class">
							...
							<p class="input_box_bord">
								<input class="form-control" type="text" name="txtNoOfGuestRooms" id="txtNoOfGuestRooms"
									size="17" maxlength="4" value=""
									onkeypress="return event.charCode >= 48 && event.charCode <= 57;">
								<label>(Max. 4 Digits)</label>
							</p>
					...
					<div class="col-xs-12 col-sm-4 ">
						<div class="inner_sm_class">
							...
							<p class="input_box_bord">
								...
								<input class="form-control" type="text" name="txtPropertyName" id="txtPropertyName"
									size="40" maxlength="128" value="">
					...
					<div class="col-xs-12 col-sm-8 	">
						<div class="inner_sm_class">
							...
							<div class="row input_box_bord" style="margin-top: 0px;">
								<div class="col-sm-3">
									<select style="width:auto;" class="form-control" name="selCountryId"
										id="selCountryId">
								...
								<div class="col-sm-6">
									<select class="form-control half_inputs" name="selStateId" id="selStateId"
										onchange="javascript:getCityByState(this.value);">
								...
								<div class="col-sm-3">
									<select class="form-control half_inputs" name="selCityId" id="selCityId"
										onchange="javascript:getLandmark(this.value);">
										<option value=""></option>
									</select>
					...
					<div class="col-xs-12 col-sm-4 ">
						<div class="inner_sm_class">
							...
							<p class="input_box_bord">
								<input class="form-control" type="text" name="txtAddress1" id="txtAddress1" size="40"
									maxlength="256" value="">
								<label>(Max. 256 Chars)</label>
							</p>
						</div>
					...
					<div class="col-xs-12 col-sm-4">
						<div class="inner_sm_class">
							...
							<p class="input_box_bord">
								<input class="form-control" type="text" name="txtAddress2" size="40" maxlength="256"
									value="">
								<label>(Max. 256 Chars)</label>
							</p>
					...
					<div class="col-xs-12 col-sm-4">
						<div class="inner_sm_class">
							...
							<p class="input_box_bord">
								<input class="form-control" type="text" name="txtZip" id="txtZip" size="40"
									maxlength="9" value=""
									onkeypress="return event.charCode >= 48 && event.charCode <= 57;">
								<label>(Max. 9 Chars)</label>
							</p>
						</div>
					...
					<div class="col-xs-12 col-sm-4 ">
						<div class="inner_sm_class">
							...
							<p class="input_box_bord">
								<input class="form-control" type="text" name="txtPhone" id="txtPhone" size="40"
									maxlength="15" value=""
									onkeypress="return event.charCode >= 48 && event.charCode <= 57;">
								<label>(Max. 10 Chars)</label>
							</p>
					...
					<div class="col-xs-12 col-sm-4 ">
						<div class="inner_sm_class">
							...
							<p class="input_box_bord">
								<input class="form-control" type="text" name="txtMobile" id="txtMobile" size="40"
									maxlength="10" value=""
									onkeypress="return event.charCode >= 48 && event.charCode <= 57;">
								<label>(Max. 10 Chars)</label>
							</p>
					...
					<div class="col-xs-12 col-sm-4">
						<div class="inner_sm_class">
							...
							<p class="input_box_bord">
								<input class="form-control" type="text" name="txtEmail" id="txtEmail" size="40"
									maxlength="256" value=""><label>Enter Valid Email Address</label>
							</p>
					...
					<div class="col-xs-12 col-sm-4 ">
						<div class="inner_sm_class">
							...
							<p class="input_box_bord">
								<input class="form-control" type="text" name="txtWebSite" id="txtWebSite" size="40"
									maxlength="256" value="">
					...
					<div class="col-xs-12 col-sm-6">
						<div class="inner_sm_class">
							...
							<p class="input_box_bord">
								...
								<textarea class="form-control" name="txtPropertyDescription"
									id="txtPropertyDescription"></textarea>
								<label>(Min. 256 Chars)</label>
							</p>
						</div>
					...
					<div class="col-xs-12 col-sm-6">
						<div class="inner_sm_class">
							...
							<p class="input_box_bord">
								<input type="file" name="propertygallery">
							</p>
						</div>
						...
						<div class="form-horizontal">
							<div class="col-sm-12 border_for_inner">
								<div class="row">
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[children_activities]"
											id="children_activities">
										<label class="control-label" for="children_activities">Children
											Activities</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[horseback_riding]"
											id="horseback_riding">
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[basketball_court]"
											id="basketball_court">
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[golf_driving_range]"
											id="golf_driving_range">
										<label class="control-label" for="golf_driving_range">Golf-Driving Range</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[golf_putting_green]"
						...
						<div class="form-horizontal">
							<div class="col-sm-12 border_for_inner">
								<div class="row">
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[complimentary_breakfast]"
											id="complimentary_breakfast">
										<label class="control-label" for="complimentary_breakfast">Complimentary
											Breakfast</label>
									</div>
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[safe_deposit_box]"
											id="safe_deposit_box">
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[room_service_24_hours]"
											id="room_service_24_hours">
										<label class="control-label" for="room_service_24_hours">Room-Service 24
											Hours</label>
									</div>


									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[handicap_facilities]"
											id="handicap_facilities">
										<label class="control-label" for="handicap_facilities">Handicap
											Facilities</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[wheel_chair_access]"
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[conference_facilities]"
											id="conference_facilities">
										<label class="control-label" for="conference_facilities">Conference
											Facilities</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[internet_access_in_rooms]"
											id="internet_access_in_rooms">
										<label class="control-label" for="internet_access_in_rooms">Internet Access in
											rooms</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[meeting_facilities]"
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[secretarial_service]"
											id="secretarial_service">
										<label class="control-label" for="secretarial_service">Secretarial
											Service</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[hair_dryer_in_room]"
											id="hair_dryer_in_room">
						...
						<div class="form-horizontal">
							<div class="col-sm-12 border_for_inner">
								<div class="row">
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[currency_exchange]"
											id="currency_exchange">
										<label class="control-label" for="currency_exchange">Currency Exchange</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[in_room_telephone_service]"
											id="in_room_telephone_service">
										<label class="control-label" for="in_room_telephone_service">In Room Telephone
											Service</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[express_check_in]"
											id="express_check_in">
										<label class="control-label" for="express_check_in">Express Check-In</label>
									</div>

									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[express_check_out]"
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[front_desk_24_hours]"
											id="front_desk_24_hours">
										<label class="control-label" for="front_desk_24_hours">Front Desk-24
											Hours</label>
									</div>
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[guest_laundromat]"
											id="guest_laundromat">
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="facilities[9_hole_golf_course]"
											id="9_hole_golf_course">
										<label class="control-label" for="9_hole_golf_course">9 hole Golf Course</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4 ">
										<input type="checkbox" name="facilities[rooms_suites_and_villas]"
											id="rooms_suites_and_villas">
										<label class="control-label" for="rooms_suites_and_villas">Rooms Suites and
											Villas</label>
									</div>
								</div>
							</div>
				...
				<div class="propertyDetailsDiv">
					<div class="row">
						<div class="col-sm-3">
							...
							<input type="text" name="txtBankAccNo" id="txtBankAccNo" size="20" maxlength="32" value=""
								onkeypress="return event.charCode >= 48 && event.charCode <= 57;">
						</div>
					...
					<div class="row">
						...
						<div class="showhide">
							<div class="col-sm-3">
								...
								<label class="control-label" style="font-weight: bold!important;">From Rs
									1000-2499</label>
								<div class="row">
									<div class="col-sm-6">
										<label class="control-label  ">CGST (%)</label>
										<input type="Text" name="" size="10"
											value="<?php echo $getHotelConfigValues[1]['value'] ?>" readonly="">
									</div>
									<div class="col-sm-6">
										<label class="control-label">SGST (%)</label>
										<input type="Text" name="" size="10"
											value="<?php echo $getHotelConfigValues[4]['value'] ?>" readonly="">
									</div>
								</div>
							</div>
							<div class="col-sm-3">
								...
								<div class="row">
									<div class="col-sm-6">
										<label class="control-label  ">CGST (%)</label>
										<input type="Text" name="" size="10"
											value="<?php echo $getHotelConfigValues[2]['value'] ?>" readonly="">
									</div>
									<div class="col-sm-6">
										<label class="control-label">SGST (%)</label>
										<input type="Text" name="" size="10"
											value="<?php echo $getHotelConfigValues[7]['value'] ?>" readonly="">
									</div>
								</div>
							</div>
							<div class="col-sm-3">
							...
							<div class="col-sm-3">
								...
								<label class="control-label" style="font-weight: bold!important;">Rs 7500 and
									above</label>
								<div class="row">
									<div class="col-sm-6">
										<label class="control-label  ">CGST (%)</label>
										<input type="Text" name="" size="10"
											value="<?php echo $getHotelConfigValues[3]['value'] ?>" readonly="">
									</div>
									<div class="col-sm-6">
										<label class="control-label">SGST (%)</label>
										<input type="Text" name="" size="10"
											value="<?php echo $getHotelConfigValues[5]['value'] ?>" readonly="">
									</div>
								</div>
							</div>
						...
						<div class="col-sm-3">
							...
							<div class="row">
								<div class="col-sm-6">
									...
									<input type="text" name="txtTAC" size="10" maxlength="2" value="">
								</div>
						...
						<div class="col-sm-9">
							...
							<div class="row">
								<div class="col-sm-12 ">
									...
									<div class="pull-left">
										<input type="checkbox" name="gstavailable" value="1"
											onclick="hideshowgst()"><label class="control-label">We Dont have
											GST</label>
									</div>
						...
						<div class="panel">
							...
							<div class="col-sm-4 ">
								...
								<input type="Text" name="cancellation_policy[]" id="cancellationpolicy1" value=""
									maxlength="3">
							...
							<div class="col-sm-3">
								...
								<input type="Text" name="cancellation_policy[]" value="" id="cancellationpolicy2"
									maxlength="3">
								<span style="font-size:9px;">Refund %</span>
							</div>
							...
							<div class="col-sm-3">
								...
								<input type="Text" name="cancellation_policy[]" value="" id="cancellationpolicy3"
									maxlength="3">
								<span style="font-size:9px;">Refund %</span>
							</div>
							...
							<div class="col-sm-12">
								<label class="control-label">1 day before check-in <span style="font-weight: 600	;">(No
										Refund)</span></label><br>
						...
						<div class="clearfix"></div>
						<div class="col-sm-6">
							<label style="width: 100%;" class="control-label ">Terms and Conditions <a
									style="float:right;font-size: 15px;color:#e31e24;" href="#terms_modal"
									data-toggle="modal" data-dismiss="modal"> <i
										class="fa fa-question-circle"></i></a></label>

							<textarea placeholder="Eg: You must be at least 18 years of age to check-in. "
								name="terms_and_conditions" id="terms_and_conditions0"></textarea>

						</div>

						<div class="col-sm-6 text-left">
							<label class="control-label " style="width: 100%; visibility: hidden;margin-top: 100px;">For
								Buttons</label>
			...
			<div class="form5 formss" style=''>
				...
				<div class="row">
					<div class="data0 datas" data='0'>
						...
						<div class="col-sm-3">
							...
							<select name="selRoomCategory[0]" id="selRoomCategory0" class="roomcategory form-control"
								onchange="javascript:getMaxOccupancy(this.value);">
						...
						<div class="col-sm-3 othercat" style="display:none">
							...
							<input type="text" value="" placeholder="Eg: Cottage" name="otherCategory[0]"
								id="otherCategory0">

						</div>
						<div class="col-sm-9 idroomtype onlyforcheckbox">
							<label class="control-label required">Room Type</label>
							<div class="row">
								<div class="col-sm-3">
									<input type="checkbox" class="id_room_types" name="id_room_type[0][]" value="1"
										id="Single0"><label class="control-label" for="Single0">Single</label>
								</div>
								<div class="col-sm-3">
									<input type="checkbox" class="id_room_types" name="id_room_type[0][]" value="2"
										id="Double0"><label class="control-label" for="Double0">Double</label>
								</div>
								<div class="col-sm-3">
									<input type="checkbox" class="id_room_types" name="id_room_type[0][]" value="3"
										id="Triple0"><label class="control-label" for="Triple0">Triple</label>

								</div>
								<div class="col-sm-3">
									<input type="checkbox" class="id_room_types" name="id_room_type[0][]" value="4"
										id="Quadruple0"><label class="control-label" for="Quadruple0">Quadruple</label>
								</div>
						...
						<div class="col-sm-3 ">
							...
							<input type="text" placeholder="Eg: Quadruple" name="txtRoomName[0]" id="txtRoomName0"
						...
						<div class="max_count_details">
							<div class="col-sm-6 ">
								...
								<div class="pull-left width50_percent">
									...
									<select class="form-control px_width60" name="selMaxNoOfGuest[0]"
										id="selMaxNoOfGuest0">
										<?php for ($i = 1; $i <= 15; $i++) { ?>
											<option value="<?php echo $i; ?>">
												<?php echo $i; ?>
							...
							<div class="col-sm-3">
								...
								<input type="text" name="noofRooms[0]" value="" id="noofRooms0"
									onkeypress="return event.charCode >= 48 && event.charCode <= 57;">
							...
							<div class="col-sm-6 isbreakfast">
								...
								<div class="row onlyforcheckbox">
									<div class="col-sm-6"><input type="checkbox" id="Include0" class="breakfast"
											name="is_breakfast[0][1]" value="1"><label class="control-label"
											for="Include0">Include</label></div>
									<div class="col-sm-6"><input type="checkbox" id="notInclude0" class="breakfast"
											name="is_breakfast[0][2]" value="2"><label class="control-label"
											for="notInclude0">Not Include</label></div>
								</div>
						...
						<div class="col-sm-12">
							...
							<div class="col-sm-12 border_for_inner">
								<div class="row">
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][direct_phone]"
											id="direct_phone0">
										<label class="control-label" for="direct_phone0">Direct Phone</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][channel_music]"
											id="channel_music0">
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][attached_bathroom]"
											id="attached_bathroom0">
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][shower_bath_tub]"
											id="shower_bath_tub0">
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][safe_deposit_boxs]"
											id="safe_deposit_boxs0">
										<label class="control-label" for="safe_deposit_boxs0">Safe Deposit Box</label>
									</div>

									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][smoke_alarms]"
											id="smoke_alarms0">
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox"
											name="roomamentities[0][high_speed_wi_fi_internet_access]"
											id="high_speed_wi_fi_internet_access0">
										<label class="control-label" for="high_speed_wi_fi_internet_access0">High speed
											Wi-Fi internet access</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][sound_proof_windows]"
											id="sound_proof_windows0">
										<label class="control-label" for="sound_proof_windows0">Sound proof
											windows</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][24_hour_room_service]"
											id="24_hour_room_service0">
										<label class="control-label" for="24_hour_room_service0">24 hour room
											service</label>
									</div>

									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][electronic_lock]"
											id="electronic_lock0">
										<label class="control-label" for="electronic_lock0">Electronic lock</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox"
											name="roomamentities[0][electronic_laptop_compatible_safe]"
											id="electronic_laptop_compatible_safe0">
										<label class="control-label" for="electronic_laptop_compatible_safe0">Electronic
											laptop compatible safe</label>
									</div>

									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][marble_flooring]"
											id="marble_flooring0">
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][free_local_phone_calls]"
											id="free_local_phone_calls0">
										<label class="control-label" for="free_local_phone_calls0">Free local phone
											calls</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][iron_with_ironing_board]"
											id="iron_with_ironing_board0">
										<label class="control-label" for="iron_with_ironing_board0">Iron with ironing
											board (on request)</label>
									</div>

									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][full_length_mirror]"
											id="full_length_mirror0">
										<label class="control-label" for="full_length_mirror0">Full length
											mirror</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][complimentary_toiletries]"
											id="complimentary_toiletries0">
										<label class="control-label" for="complimentary_toiletries0">Complimentary
											toiletries</label>
									</div>
									...
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][tea_coffee_maker]"
											id="tea_coffee_maker0">
										<label class="control-label" for="tea_coffee_make0r">Tea/Coffee Maker</label>
									</div>

									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][complimentary_tea_coffee]"
											id="complimentary_tea_coffee0">
										<label class="control-label" for="complimentary_tea_coffee0">Complimentary
											Tea/Coffee</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox"
											name="roomamentities[0][complimentary_packed_water_bottles]"
											id="complimentary_packed_water_bottles0">
										<label class="control-label"
											for="complimentary_packed_water_bottles0">Complimentary Packed Water
											Bottles</label>
									</div>

									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][carpet_flooring]"
											id="carpet_flooring0">
										<label class="control-label" for="carpet_flooring0">Carpet Flooring</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][complimentary_fruit_basket]"
											id="complimentary_fruit_basket0">
										<label class="control-label" for="complimentary_fruit_basket0">Complimentary
											Fruit Basket</label>
									</div>

									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][high_speed_wi_fi_internet]"
											id="high_speed_wi_fi_internet0">
										<label class="control-label" for="high_speed_wi_fi_internet0">High Speed Wi-Fi
											Internet (chargeable)</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][double_twin_beds]"
											id="double_twin_beds0">
										<label class="control-label" for="double_twin_beds0">Double/Twin Beds</label>
									</div>

									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][direct_dialing_phone]"
											id="direct_dialing_phone0">
										<label class="control-label" for="direct_dialing_phone0">Direct-Dialing
											Phone</label>
									</div>
									<div class="col-xs-12 col-sm-4 col-md-4">
										<input type="checkbox" name="roomamentities[0][smoke_detector_alarms]"
											id="smoke_detector_alarms0">
										<label class="control-label" for="smoke_detector_alarms0">Smoke Detector
											Alarms</label>
									</div>
							...
							<div class="col-sm-12">
								...
								<div class="col-sm-12 border_for_inner ">
									<div class="row">
										...
										<div class="col-xs-12 col-sm-4 col-md-4">
											<input type="checkbox" name="roomamentities[0][mountain_view]"
												id="mountain_view0">
											<label class="control-label" for="mountain_view0">Mountain view</label>
										</div>
										<div class="col-xs-12 col-sm-4 col-md-4">
											<input type="checkbox" name="roomamentities[0][sea_facing_room]"
												id="sea_facing_room0">
						...
						<div class="col-sm-6">
							...
							<textarea name="txtRoomDescription[0]" id="txtRoomDescription0"
								class="autoload_rte"></textarea>
				...
				<div class="col-sm-12">
					...
					<button value="1" type="button" class="add_room button_addremove" onclick="AddRoom(this.value)"><i
			...
			<div class="form6 formss" style=''>
				...
				<div class="panel" id="fieldset_2">
					<div class="panel-heading">
						<i></i><label class="control-label">Meal Plans Incl.</label>&nbsp;&nbsp;<input type="checkbox"
							class="switchMealPlans" name="is_meal_plan">
					</div>
						...
						<table class="table" id="mealPlansTable">
							...
							<tbody>
								<tr>
									...
									<td>
										<div class="col-lg-6">
											<input type="text" name="rateLunchAdult" size="17" maxlength="5" value=""
												disabled=""
												onkeypress="return event.charCode >= 48 && event.charCode <= 57;">
										</div>
									</td>
									<td>
										<div class="col-lg-6">
											<input type="text" name="rateLunchMoreThanFive" size="17" maxlength="5"
												value="" disabled=""
												onkeypress="return event.charCode >= 48 && event.charCode <= 57;">
										</div>
									</td>
								...
								<tr>
									...
									<td>
										<div class="col-lg-6">
											<input type="text" name="rateDinnerAdult" size="17" maxlength="5" value=""
												disabled=""
												onkeypress="return event.charCode >= 48 && event.charCode <= 57;">
										</div>
									</td>
									<td>
										<div class="col-lg-6">
											<input type="text" name="rateDinnerMoreThanFive" size="17" maxlength="5"
												value="" disabled=""
												onkeypress="return event.charCode >= 48 && event.charCode <= 57;">
										</div>
									</td>
...
">
		<div class="modal-content" style="position: relative;">
			...
			<div class="modal-body">
				...
				<h3>INTRODUCTION</h3>
				<p>
					The purpose of this document is to regulate the GENERAL TERMS or CONDITIONS OF PROCUREMENT of the
					Pre-booking and Online Booking services (hereafter, and interchangeably, ‘Pre-booking’ and ‘Online
					Booking’ services, or ‘services’) with registered offices in established by Public Deed executed
					before, The terms “You” and “User” are used here to refer to all individuals and/or entities who for
					whatever reason access www.nh-hotels.com or use its services. </p>
				<p>
					The use of these services implies full and unconditional acceptance and validity of each and all the
					General Terms and/or Conditions – which are deemed to be automatically incorporated into the
					contract concluded with NH, without the need for your written transcription in the same – included
					in the latest version of these General Terms and/or Conditions.
					2. USE OF THE NH PRE-BOOKING AND ONLINE BOOKING SERVICES</p>

				<h3>Pre-booking Services </h3>
				<p>
					The online Pre-booking services are for information only, and their sole purpose is to offer the
					user the possibility of checking the availability of a room in their preferred hotel or city. THE
					USER WILL RECEIVE AN EMAIL WITHIN 24 HRS, CONFIRMING IF THEIR BOOKING HAS BEEN PROCESSED, AND WILL
					CONSEQUENTLY ONLY BECOME BINDING ONCE NH HAS ACCEPTED THE RESERVATION BY MEANS OF EMAIL CONFIRMATION
					AND SUBSEQUENT PAYMENT BY THE USER. The user must verify the booking confirmation and notify NH of
					any error immediately in writing.
				</p>
				<h3>Online Booking Services </h3>

				<p>a. The purpose of the Online Booking services is for the reservation of a room in any NH hotel. THE
					USE OF THESE SERVICES IMPLIES FULL AND UNCONDITIONAL ACCEPTANCE AND VALIDITY OF EACH AND ALL THE
					GENERAL TERMS AND/OR CONDITIONS – WHICH ARE DEEMED TO BE AUTOMATICALLY INCORPORATED INTO THE
					CONTRACT CONCLUDED WITH NH, WITHOUT THE NEED FOR YOUR WRITTEN TRANSCRIPTION IN THE SAME – INCLUDED
					IN THE LATEST VERSION OF THESE GENERAL TERMS AND/OR CONDITIONS. </p>
				<p>
					b. Procurement procedure: When using the service, the user will receive an email confirmation in
					which is included the confirmation that their purchase order is in the process of being confirmed.
					If you are a customer, once the corresponding debit for your reservation has been made, you will
					receive an email confirming this; this email serves as proof of your booking. </p>
				<p>
					c. Guarantee: The booking is confirmed and guaranteed overnight with a credit card. In the event of
					a no-show without prior notice, the first night will be charged (including VAT and taxes).
				</p>
				<p>
					d. Termination of the contract or cancellation of the booking: The credit card is solely a means of
					guarantee. Cancellation of the booking by the user will not incur any charges for advance
					cancellation, provided that this is done prior to the specified deadline in each country (local time
					at the hotel) on the day of arrival. Once this threshold has passed, NH will make a cancellation
					charge as compensation, which will amount to the cost of the first night (including VAT and taxes),
					with the exception of hotels in Germany, where 10% of the stay may be refunded as compensation for
					expenses not incurred.
				</p>
				<p>
					This clause does not apply to bookings made with special rates. In this case, the respective
					specified conditions shall apply.
...
<script>
	function hideshowgst(data) {//('input[name="gstavailable"]:checkbox:checked')
	...
	var count=selectedcat.length;*/
			...
			$(".datas").each(function () {
				var value = sel = $(this).find(".roomcategory option:selected").val();
				data = $(this).attr("data");
				...
				$(".datas").each(function () {
					...
					if (value != '13') {
						...
						$.each($(".data" + data + " .id_room_types:checked"), function () {
							...
							var txtromename = $("#txtRoomName" + data).val();
							//'+(breakfst.includes("1"))?"inline":""+'
							var display = (breakfst.includes("1")) ? "table-row" : "none";
							var req = (breakfst.includes("1")) ? "required" : "";
							roomrates += '<tr style="display:' + display + '"><td>' + txtromename + '<br><em>(' + category_name + ')</em></td><td>' + name + '</td><td>With Breakfast</td><td><input type="text" name="txtMasterRate[' + value + '][' + option + '][with][]" size="17" maxlength="5"  value="" ' + req + ' onkeypress="return event.charCode >= 48 && event.charCode <= 57;"></tr>';
							var display = (breakfst.includes("2")) ? "table-row" : "none";
							var req = (breakfst.includes("2")) ? "required" : "";
							roomrates += '<tr style="display:' + display + '"><td>' + txtromename + '<br><em>(' + category_name + ')</em></td><td>' + name + '</td><td>Without Breakfast</td><td><input type="text" name="txtMasterRate[' + value + '][' + option + '][without][]" size="17" maxlength="5"  ' + req + ' value="" onkeypress="return event.charCode >= 48 && event.charCode <= 57;"></tr>';
						...
						var display = (breakfst.includes("1")) ? "table-row" : "none";
						var req = (breakfst.includes("1")) ? "required" : "";
						roomrates += '<tr style="display:' + display + '"><td ><br><em>(' + category_name + ': ' + name + ')</em></td><td>' + name + '</td><td>With Breakfast</td><td><input type="text" name="txtMasterRate[' + value + '][' + option + '][with][]" size="17"  maxlength="5" value="" ' + req + ' onkeypress="return event.charCode >= 48 && event.charCode <= 57;"></td></tr>';
						var display = (breakfst.includes("2")) ? "table-row" : "none";
						var req = (breakfst.includes("2")) ? "required" : "";
						roomrates += '<tr style="display:' + display + '"><td ><br><em>(' + category_name + ': ' + name + ')</em></td><td>' + name + '</td><td>Without Breakfast</td><td><input type="text" name="txtMasterRate[' + value + '][' + option + '][without][]" size="17"  maxlength="5" value="" ' + req + ' onkeypress="return event.charCode >= 48 && event.charCode <= 57;"></td></tr>';
	...
	function AddRoom(num) {
		...
		addroom += '</div>';
		addroom += '</div>';
		addroom += '<div class="col-xs-12 col-sm-9 idroomtype onlyforcheckbox">';
		addroom += '<label class="control-label ">Room Type</label>';
		addroom += '<div ><div class="row">';
		addroom += '<div class="col-sm-3"><input type="checkbox" id="Single' + num + '" class="id_room_types" name="id_room_type[' + num + '][]" value="1" for="Single' + num + '"><label class="control-label" >Single</label></div>';
		addroom += '<div class="col-sm-3"><input type="checkbox"  id="Double' + num + '" class="id_room_types" name="id_room_type[' + num + '][]" value="2" ><label class="control-label" for="Double' + num + '">Double</label></div>';
		addroom += '<div class="col-sm-3"><input type="checkbox"  id="Triple' + num + '" class="id_room_types" name="id_room_type[' + num + '][]" value="3" ><label class="control-label" for="Triple' + num + '">Triple</label></div>';
		addroom += '<div class="col-sm-3"><input type="checkbox"  id="Quadruple' + num + '" class="id_room_types" name="id_room_type[' + num + '][]" value="4" ><label class="control-label" for="Quadruple' + num + '">Quadruple</label></div>';
		...
		addroom += '<div >';
		addroom += '<input type="text" name="txtRoomName[' + num + ']" id="txtRoomName' + num + '" size="40" maxlength="40" value="">';
		...
		addroom += '<div class="row onlyforcheckbox"><div class="col-sm-6"><input type="checkbox" id="Include' + num + '" class="breakfast" name="is_breakfast[' + num + '][1]" value="1" ><label class="control-label" for="Include' + num + '" >Include</label></div><div class="col-sm-6"><input type="checkbox" id="notInclude' + num + '" class="breakfast" name="is_breakfast[' + num + '][2]" value="2"><label class="control-label"  for="notInclude' + num + '">Not Include</label></div></div>';
		addroom += '</div>';
		addroom += '</div>';
		addroom += '</div>';
